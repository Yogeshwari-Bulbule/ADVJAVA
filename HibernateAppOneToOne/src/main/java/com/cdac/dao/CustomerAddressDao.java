...
public class CustomerAddressDao {
	...
	public List<Customer> fetchCustomersByCity(String city) {
		...
		// select c.* from tbl_cust c join tbl_addr a on c.addr_id = a.addr_id where a.city = ?
	...
	public Address fetchAddressByCustomerName(String name) {
		...
		// select a.* from tbl_addr a join tbl_cust c on a.addr_id = c.addr_id where a.name = ?
